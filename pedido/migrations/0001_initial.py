    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mesa', models.CharField(max_length=255, verbose_name='Mesa')),
                ('observacion', models.CharField(blank=True, max_length=255, null=True, verbose_name='Observación')),
                ('estatus', models.IntegerField(choices=[(0, 'Cancelado'), (1, 'Actva'), (2, 'Pre-pagada'), (3, 'Cerrada')], default=1, verbose_name='Estatus')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_modificacion', models.DateTimeField(auto_now=True, verbose_name='Fecha modificación')),
                ('fecha_alta', models.DateTimeField(auto_now_add=True, verbose_name='Fecha alta')),
                ('comanda', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pedido.comanda', verbose_name='Comanda')),
